...
<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index-2.html"><img class="img-fluid" src="{{ asset('admin/assets/images/logo/logo.png') }}"
                        alt=""></a></div>
        ...
        <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div class="notification-slider">
                <div class="d-flex h-100"> <img src="{{ asset('admin/assets/images/giftools.gif') }}" alt="gif">
                        ...
                        <ul>
                            <li>
                                <div class="media"><img class="img-fluid b-r-5 me-3 img-60"
                                        src="{{ asset('admin/assets/images/other-images/cart-img.jpg') }}" alt="">
