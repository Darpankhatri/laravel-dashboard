            ...
            <div class="row widget-grid">
                    ...
                    <div class="card profile-box">
                        <div class="card-body">
                            ...
                            <div class="cartoon"><img class="img-fluid"
                                    src="{{ asset('admin/assets/images/dashboard/cartoon.svg') }}"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><img class="img-fluid img-40 rounded-circle"
                                                        src="{{ asset('admin/assets/images/dashboard/user/1.jpg') }}"
                                                        alt="user"></td>
                                            ...
                                            <tr>
                                                <td><img class="img-fluid img-40 rounded-circle"
                                                        src="{{ asset('admin/assets/images/dashboard/user/2.jpg') }}"
                                                        alt="user"></td>
                                                <td class="img-content-box"><a class="d-block f-w-500"
                                            ...
                                            <tr>
                                                <td><img class="img-fluid img-40 rounded-circle"
                                                        src="{{ asset('admin/assets/images/dashboard/user/3.jpg') }}"
                                                        alt="user"></td>
                                                <td class="img-content-box"><a class="d-block f-w-500"
                                            ...
                                            <tr>
                                                <td><img class="img-fluid img-40 rounded-circle"
                                                        src="{{ asset('admin/assets/images/dashboard/user/4.jpg') }}"
                                                        alt="user"></td>
                                                <td class="img-content-box"><a class="d-block f-w-500"
                                            ...
                                            <tr>
                                                <td><img class="img-fluid img-40 rounded-circle"
                                                        src="{{ asset('admin/assets/images/dashboard/user/5.jpg') }}"
                                                        alt="user"></td>
                                                <td class="img-content-box"><a class="d-block f-w-500"
                                                        href="user-profile-2.html">Mark Green</a><span class="f-light">1
                                                        day ago</span></td>
                                                <td class="text-end">
                ...
                <div class="col-xxl-3 col-md-6 box-col-6 col-ed-none wow zoomIn">
                    <div class="card purchase-card"><img class="img-fluid"
                            src="{{ asset('admin/assets/images/dashboard/purchase.png') }}" alt="vector mens with leptop">
                ...
                <div class="col-xxl-5 col-lg-8 col-md-11 box-col-8 col-ed-6">
                    <div class="card papernote-wrap">
                        ...
                        <div class="card-body pt-0"> <img class="banner-img img-fluid"
                                src="{{ asset('admin/assets/images/dashboard/papernote.jpg') }}"
                                    ...
                                    <div class="customers">
                                        <ul>
                                            <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                    ...
                                                    alt="user"></li>
                                            <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                    src="{{ asset('admin/assets/images/dashboard/user/6.jpg') }}"
                                                    alt="user"></li>
                                            <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                    src="{{ asset('admin/assets/images/dashboard/user/7.jpg') }}"
                                                    alt="user"></li>
                                            <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                    src="{{ asset('admin/assets/images/dashboard/user/3.jpg') }}"
                                                    alt="user"></li>
                                            <li class="d-inline-block"><img class="img-40 rounded-circle"
                                                    src="{{ asset('admin/assets/images/dashboard/user/8.jpg') }}"
                                                    alt="user"></li>
